 ...
 */
public class LoliKeyboard extends InputMethodService
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        //changin language added By Win Htaik Aung
        else if (primaryCode == 0 && mInputView != null){
            Keyboard current_keyboard=mInputView.getKeyboard();
            if(current_keyboard==mQwertyKeyboard ||current_keyboard==mQwertymmShiftedKeyboard ){
                current_keyboard=mQwertymmKeyboard;
            }else{
